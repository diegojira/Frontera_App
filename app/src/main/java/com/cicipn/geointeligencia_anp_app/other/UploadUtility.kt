...
class UploadUtility(activity: Activity) {
    ...
    var serverURL: String = "http://192.168.0.3/geoInteligencia_ANP/saveRoute.php"
    var serverUploadDirectoryPath: String = "http://192.168.0.3/geoInteligencia_ANP/geojson/"
